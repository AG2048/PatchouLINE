...
current version: V6
working on: finished translations, minor colour adjustments
*/
...
void processInitInput(WiFiClient client) {
  ...
  client.println("<h2>Plot Width / <i>Lebar Petak </i>(X): <span id='x_width'>42</span></h2>");                                //THIS IS THE PART SEEN ON THE SCREEN
...
// Add event listener for click"
            ...
            // debug, change the plot reading every refresh
...
void loop() {
  ...
  switch (big_state) {
    ...
    case 1:
      ...
      //no longer needed for the prototype
