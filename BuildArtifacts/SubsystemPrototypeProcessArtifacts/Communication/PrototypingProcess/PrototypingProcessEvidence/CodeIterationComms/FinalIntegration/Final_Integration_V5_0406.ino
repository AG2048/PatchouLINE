/*
FINAL INTEGRATION
last update: april 56th, 2024
current version: V5
working on: indonesian translations started
*/
...
void processAutoInput(WiFiClient client) {
  ...
  client.println("<h1 style='font-family: Tahoma'>Automatic Mode Parameters /<i> Parameter Mode Otomatis </i> </h1>");
